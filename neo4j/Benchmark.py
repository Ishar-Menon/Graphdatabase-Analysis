...
os.system('sudo mkdir {}/Empty_Bench'.format(sys.argv[1]))
for _ in range(NO_OF_TESTS_EACH):
    empty_cmd = 'sudo taskset -c 24-47,72-95 sudo perf stat -e task-clock,context-switches,cpu-migrations,page-faults,cycles,instructions,cache-references,cache-misses,branches,branch-misses,LLC-loads,LLC-load-misses,LLC-stores,LLC-prefetches,iTLB-loads,iTLB-load-misses,dTLB-loads,dTLB-load-misses,dTLB-prefetch-misses,L1-dcache-loads,L1-dcache-load-misses,L1-dcache-stores,L1-dcache-store-misses,L1-dcache-prefetches,L1-dcache-prefetch-misses,L1-icache-loads,L1-icache-load-misses,L1-icache-prefetches,L1-icache-prefetch-misses -C 0-11,48-59 -- sleep 30 2> {}/Empty_Bench/Empty_Bench_{}'.format(sys.argv[1],_)
    print(empty_cmd)
    os.system(empty_cmd)
...
for _ in range(NO_OF_TESTS):
    ...
    for i in range(NO_OF_TESTS_EACH):
        ...
        client_cmd = 'python3 client.py {}'.format(_ + 1)
